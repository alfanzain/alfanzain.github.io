    ...
    >
      ...
      >
        <div className="relative flex flex-col min-h-screen">
          <div className="absolute inset-x-0 top-0 z-[-1] pointer-events-none h-screen overflow-hidden">
            <Image
          ...
          <div className="absolute flex flex-col-reverse inset-x-0 bottom-0 z-[-1] pointer-events-none h-screen overflow-hidden">
            <Image
